...
INSERT INTO public.saas_plans(code,name,monthly_price_cents,included_seats,extra_seat_price_cents,monthly_ticket_limit,storage_limit_mb,features) VALUES
 ('START','SAC Start',49900,5,7900,500,5120,'{"dashboard":true,"attachments":true,"sla":true}'),
 ('PRO','SAC Profissional',119900,15,6900,3000,25600,'{"dashboard":true,"attachments":true,"sla":true,"api":true,"custom_branding":true}'),
 ('ENTERPRISE','SAC Enterprise',249900,40,5900,NULL,102400,'{"dashboard":true,"attachments":true,"sla":true,"api":true,"sso":true,"audit_export":true}')
