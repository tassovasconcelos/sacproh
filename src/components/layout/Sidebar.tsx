...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return <>
    <aside className="w-64 bg-[#0B2343] text-slate-300 min-h-[calc(100vh-4rem)] border-r border-slate-700/60 p-3 flex flex-col justify-between flex-shrink-0">
      ...
      <div className="p-3 bg-slate-800/60 rounded-xl border border-slate-700/60 text-center"><p className="text-[11px] font-bold text-white">SACPROH · Procirúrgica</p><p className="text-[10px] text-slate-400 mt-0.5">Gestão integrada de atendimento</p></div>
    </aside>
