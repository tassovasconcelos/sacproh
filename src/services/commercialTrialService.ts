...
export type PlatformUser={id:string;tenant_id:string;full_name:string;email:string;role_code:string;is_active:boolean;created_at:string;tenant?:{name:string;trade_name?:string|null}|null};
...
export type PlatformOverview={trials:CommercialTrial[];subscriptions:CommercialCustomer[];orders:PlatformOrder[];alerts:CommercialAlert[];users:PlatformUser[]};
